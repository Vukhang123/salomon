...
<head>
    ...
    <link href="dangky.css" type="text/css" rel="stylesheet" />
</head>
<body>
    <div class="signin">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Password</label>
                        <input type="password"  name="kh_matkhau" id="kh_matkhau" placeholder="Password">
                </div>
            </div>
        ...
        Tên: <input type="text" name="kh_ten" id="kh_ten"  placeholder="Name"/><br />
        Giới tính: 
        ...
        <br />
        Địa chỉ: <input type="text" name="kh_diachi" id="kh_diachi"  placeholder="Adress"/><br />
        Điện thoại: <input type="text" name="kh_dienthoai" id="kh_dienthoai"  placeholder="Number Phone"/><br />
        Email: <input type="text" name="kh_email" id="kh_email"   placeholder="Enter email"/><br />
        <div>
        Ngày sinh: <input type="text" name="kh_ngaysinh" id="kh_ngaysinh"  placeholder="Day"/>
        Tháng sinh: <input type="text" name="kh_thangsinh" id="kh_thangsinh"  placeholder="Month"/>
        Năm sinh: <input type="text" name="kh_namsinh" id="kh_namsinh"  placeholder="Year"/>
        </div>
        <div>
        CMND: <input type="text" name="kh_cmnd" id="kh_cmnd"  placeholder="Chứng Minh Nhân Dân"/><br />
        </div>
        Có quyền Quản trị:
        <input type="checkbox" id="kh_quantri" name="kh_quantri" value="1" /><br/>
        <a href=""><input type="button" value="Đăng Ký" >
        </form>
        <?php
        if(isset($_POST['btnLuu'])) {
            ...
            $sqlInsert = "INSERT INTO khachhang (kh_tendangnhap, kh_matkhau, kh_ten, kh_gioitinh, kh_diachi, kh_dienthoai, kh_email, kh_ngaysinh, kh_thangsinh, kh_namsinh, kh_cmnd, kh_makichhoat, kh_quantri) VALUES ('$kh_tendangnhap', '$kh_matkhau', '$kh_ten', $kh_gioitinh, '$kh_diachi', '$kh_dienthoai', '$kh_email', $kh_ngaysinh, $kh_thangsinh, $kh_namsinh, '$kh_cmnd', '$kh_makichhoat', $kh_quantri)";
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <a href="http://localhost/salomon/page/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                    </td>
                </tr>
                <tr>
                    <td>
